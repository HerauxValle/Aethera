    ...
    Connections {
        ...
        function onTintIndexChanged() {
            const palettes = [
                ...
                { primary:"#5C8FA5", surface:"#08141A", surfC:"#0D1E28", surfCH:"#152E3A", popupBg:"#D6081220", popupBorder:"#28FFFFFF", text:"#EAF4F8", muted:"#9EB5BF", outline:"#1E3A4A", outlineV:"#122530", onPrimary:"#04141E" },
                // 1: Purple
